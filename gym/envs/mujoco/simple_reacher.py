...
class SimpleReacherEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self):
        ...
        # self.object_xml_paths = natsorted(glob.glob(os.path.join(os.path.dirname(__file__), "assets/multi_cube_reach_xmls/*")))
        # # shuffle(self.object_xml_paths)
    ...
    def step(self, a):
        ...
        # reward_dist_1 = - np.linalg.norm(vec_1)
        #
